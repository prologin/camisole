...
html_sidebars = { '**': ['camisole.html', 'globaltoc.html', 'relations.html', 'sourcelink.html', 'searchbox.html'], }
...
man_pages = [
    (master_doc, 'camisole', 'camisole Documentation',
     [author], 1)
]
